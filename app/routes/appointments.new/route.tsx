				...
				<div className="mx-auto max-w-2xl">
					...
					>
						...
						<div className="mb-6">
							...
							{patients.length === 0 ? (
								<div className="rounded-2xl border-2 border-medical-blue p-6 text-center">
									...
									<Link
										to="/patients/new"
										className="inline-block rounded-full bg-doctor-green px-6 py-2 font-semibold text-white hover:bg-doctor-green-dark"
									>
						...
						{/* Patient Preview */}
						{selectedPatientData && (
							<div className="mb-6 rounded-2xl bg-medical-light p-4">
